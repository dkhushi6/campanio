    ...
    <div className="max-w-4xl mx-auto px-4 py-12 mt-17 space-y-10 min-h-[calc(100vh-61px)]">
      ...
      <div className="grid md:grid-cols-2 gap-8 w-full max-w-4xl">
        ...
        <Link href="/journal/new">
          <Card className="rounded-xl cursor-pointer group hover:border-[#6059E7] hover:shadow-[0_8px_25px_rgba(96,89,231,0.6)] transition-all duration-300 shadow-lg">
